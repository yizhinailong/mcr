/**
 * @file delete.cpp
 * @brief Demonstrate mcr::Delete with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "delete", [](example::Arguments const& args) {
        auto const response{ mcr::Delete(
            mcr::Url{ args.url },
