/**
 * @file patch.cpp
 * @brief Demonstrate mcr::Patch with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "patch", [](example::Arguments const& args) {
        auto const response{ mcr::Patch(
            mcr::Url{ args.url },
