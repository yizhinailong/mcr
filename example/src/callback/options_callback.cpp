/**
 * @file options_callback.cpp
 * @brief Demonstrate mcr::OptionsCallback with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "options_callback", [](example::Arguments const& args) {
        auto completion{ mcr::OptionsCallback(
