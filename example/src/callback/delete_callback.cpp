/**
 * @file delete_callback.cpp
 * @brief Demonstrate mcr::DeleteCallback with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "delete_callback", [](example::Arguments const& args) {
        auto completion{ mcr::DeleteCallback(
