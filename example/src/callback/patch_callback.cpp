/**
 * @file patch_callback.cpp
 * @brief Demonstrate mcr::PatchCallback with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "patch_callback", [](example::Arguments const& args) {
        auto completion{ mcr::PatchCallback(
