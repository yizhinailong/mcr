/**
 * @file post_callback.cpp
 * @brief Demonstrate mcr::PostCallback with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "post_callback", [](example::Arguments const& args) {
        auto completion{ mcr::PostCallback(
