/**
 * @file patch_async.cpp
 * @brief Demonstrate mcr::PatchAsync with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "patch_async", [](example::Arguments const& args) {
        auto pending{ mcr::PatchAsync(
            mcr::Url{ args.url },
