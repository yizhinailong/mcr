/**
 * @file options_async.cpp
 * @brief Demonstrate mcr::OptionsAsync with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "options_async", [](example::Arguments const& args) {
        auto pending{ mcr::OptionsAsync(
            mcr::Url{ args.url },
