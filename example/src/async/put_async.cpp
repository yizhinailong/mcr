/**
 * @file put_async.cpp
 * @brief Demonstrate mcr::PutAsync with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "put_async", [](example::Arguments const& args) {
        auto pending{ mcr::PutAsync(
            mcr::Url{ args.url },
