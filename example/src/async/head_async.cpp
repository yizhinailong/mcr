/**
 * @file head_async.cpp
 * @brief Demonstrate mcr::HeadAsync with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "head_async", [](example::Arguments const& args) {
        auto pending{ mcr::HeadAsync(
            mcr::Url{ args.url },
