/**
 * @file post_async.cpp
 * @brief Demonstrate mcr::PostAsync with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "post_async", [](example::Arguments const& args) {
        auto pending{ mcr::PostAsync(
            mcr::Url{ args.url },
