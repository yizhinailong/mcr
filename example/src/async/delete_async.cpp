/**
 * @file delete_async.cpp
 * @brief Demonstrate mcr::DeleteAsync with an explicit call to this public request API.
 */
import std;
import mcr;
...
auto main(int argc, char** argv) -> int {
    return example::run(argc, argv, "delete_async", [](example::Arguments const& args) {
        auto pending{ mcr::DeleteAsync(
            mcr::Url{ args.url },
